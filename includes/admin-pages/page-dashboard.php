 ...
 * Description: Dashboard Admin dengan tampilan SaaS Modern.
 */
...
function dw_dashboard_page_render() {
    ...
    // --- 1. DATA STATISTIK (REAL TIME) ---
    $count_desa = $wpdb->get_var("SELECT COUNT(id) FROM {$wpdb->prefix}dw_desa WHERE status = 'aktif'") ?: 0;
    $count_pedagang = $wpdb->get_var("SELECT COUNT(id) FROM {$wpdb->prefix}dw_pedagang WHERE status_akun = 'aktif'") ?: 0;
    $count_produk = $wpdb->get_var("SELECT COUNT(id) FROM {$wpdb->prefix}dw_produk WHERE status = 'aktif'") ?: 0;
    ...
    <div class="wrap dw-wrap">
        ...
        <div class="dw-saas-banner">
            ...
            <p>Selamat datang kembali di panel pengelolaan Desa Wisata. Pantau performa transaksi dan aktivitas desa secara real-time.</p>
        </div>
        ...
        <div class="dw-stats-grid">
            ...
            <div class="dw-stat-card">
                <div class="dw-stat-header">
                    ...
                    <span class="dw-trend-badge trend-up">↗ +5.4%</span>
                </div>
                <div>
                    <h3 class="dw-stat-value">Rp <?php echo number_format($omset, 0, ',', '.'); ?></h3>
                    <span class="dw-stat-label">Total Omset</span>
                </div>
            </div>
            ...
            <div class="dw-stat-card">
                <div class="dw-stat-header">
                    ...
                    <span class="dw-trend-badge trend-up">↗ +12%</span>
                </div>
                <div>
            ...
            <div class="dw-stat-card">
                <div class="dw-stat-header">
                    ...
                    <span class="dw-trend-badge trend-neutral">+0%</span>
                </div>
                <div>
                    <h3 class="dw-stat-value"><?php echo number_format($count_pedagang); ?></h3>
                    <span class="dw-stat-label">Toko Aktif</span>
                </div>
            </div>
        ...
        <div class="dw-content-grid">
            ...
            <div class="dw-panel">
                <div class="dw-panel-header">
                    ...
                    <!-- Dropdown dummy -->
                    <select style="font-size:12px; padding:2px 24px 2px 8px; border:1px solid #ddd; background:none;">
                    ...
                    <?php if ($omset > 0): ?>
                        <div class="dw-saas-chart">
                            <?php foreach ($chart_data as $data): 
                                ...
                                // Style bar agar lebih menarik (warna biru solid untuk data, abu-abu untuk 0)
            ...
            <!-- Right: List (Transaksi Terakhir / Keberangkatan) -->
            <div class="dw-panel">
                <div class="dw-panel-header">
                    <h3>Transaksi Terakhir</h3>
                    <a href="?page=dw-logs" style="font-size:12px; text-decoration:none;">Lihat Semua</a>
                </div>
