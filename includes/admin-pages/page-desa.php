 ...
 * Version: 6.7 (Layout Refinement)
 * @package DesaWisataCore
 */

defined('ABSPATH') || exit;

// --- 1. FIX PATHS & INCLUDES (Menggunakan Relative Path agar Aman) ---
...
if (!function_exists('dw_desa_page_render')) {
    function dw_desa_page_render() {
        ...
        $users = get_users([
            ...
            'role'    => 'desa_admin' // Asumsi role adalah desa_admin
        ]);
        ...
        <div class="wrap dw-admin-wrapper">
            ...
            <nav class="nav-tab-wrapper" style="margin-bottom:20px;">
                ...
                <a href="?page=dw-desa&tab=verifikasi" class="nav-tab <?php echo $active_tab == 'verifikasi' ? 'nav-tab-active' : ''; ?>">
                    ...
                    <?php if($count_verify > 0) echo '<span class="awaiting-mod count-<?php echo $count_verify; ?>"><span class="pending-count">' . $count_verify . '</span></span>'; ?>
                </a>
            ...
            <?php if($active_tab == 'data_desa'): ?>
                                ...
                                <table class="dw-modern-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($r->status_akses_verifikasi == 'active'): ?><span class="dw-badge status-success">Premium</span>
                                                <?php elseif($r->status_akses_verifikasi == 'pending'): ?><span class="dw-badge status-warning">Pending</span>
                                                <?php else: ?><span class="dw-badge status-neutral">Free</span><?php endif; ?>
                                            </td>
                ...
                <?php else: ?>
                    ...
                    <form method="post" class="dw-form-grid">
                        ...
                        <!-- Layout Split: Main Content Left (2fr), Sidebar Right (1fr) -->
                                ...
                                <div class="dw-card">
                                    ...
                                    <div class="dw-card-body">
                                        <div class="dw-form-group">
                                            ...
                                            <div class="dw-help-text">Hanya menampilkan user dengan role 'Admin Desa' yang belum memiliki desa.</div>
                                        </div>
                                        <div class="dw-form-group">
                                        ...
                                        <div class="dw-form-group">
                                            <label class="dw-label">Nomor WhatsApp (Kontak Desa)</label>
                                        ...
                                        <div class="dw-form-group">
                                            <label class="dw-label">Kode Referral (Otomatis)</label>
                                            ...
                                            <small class="dw-help-text">Format: [3 PRO]-[3 KAB]-[3 DES]-[4 ACAK]. Klik tombol dadu setelah mengisi data wilayah.</small>
                                        </div>
                                        <div class="dw-form-group">
                            ...
                            <div class="dw-sidebar">
                                ...
                                <div class="dw-card">
                                    ...
                                    <div class="dw-card-body">
                                        <div class="dw-form-group">
                                            <div style="margin-bottom:10px; background:#f0f2f5; padding:10px; border-radius:8px; text-align:center;">
                                                <img src="<?php echo !empty($edit_data->foto_sampul) ? esc_url($edit_data->foto_sampul) : 'https://via.placeholder.com/300x150?text=Sampul'; ?>" class="img-preview" id="preview_sampul" style="max-width:100%; height:auto;">
                                            </div>
                                            <input type="hidden" name="foto_sampul_url" id="foto_sampul_url" value="<?php echo esc_attr($edit_data->foto_sampul); ?>">
                                            <button type="button" class="dw-button dw-button-secondary btn_upload" data-target="#foto_sampul_url" data-preview="#preview_sampul" style="width:100%;">Upload Foto Sampul</button>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- End Sidebar -->
